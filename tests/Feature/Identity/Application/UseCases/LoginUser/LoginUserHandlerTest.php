...
namespace Tests\Feature\Identity\Application\UseCases\LoginUser;

use App\Identity\Application\UseCases\LoginUser\LoginUserCommand;
...
class LoginUserHandlerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = app(LoginUserHandler::class);
    }
    ...
    public function testHandleSuccessfully(): void
    {
        ...
        $this->assertSame($userModel->id, $result->id);
        $this->assertSame($userModel->email, $result->email);
    }
